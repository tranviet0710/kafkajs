...
import { getCurrencyFromAddress, sendSocketMessage } from "./utils.js";
import { KafkaTopics, WebSocketEvents } from "./events.js";
...
const prices = { btc: null, eth: null }; // currency -> price

async function pleaseCrawlBalance(address, currency) {
